    ...
    public static void main(String[] args) {
        {
            ...
            System.out.println(" El colectivo con capacidad para " + capacidad + " personas requiere de " + cantidadViajes + " viajes para transportar los " + turistasPagos + " turistas. Los turistas deben pagar " + PagoTuristas + " pesos en total. El conductor debera pagarle al propietario la suma de: " + GananciaPropietario + " pesos.");
